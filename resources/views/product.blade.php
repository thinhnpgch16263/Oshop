    ...
    <div class="row">
        <div style="width: 20%; margin-left: 1%">
            ...
            @foreach($cate as $item)
                <a href="{{route('getbuycate', $item->cateid)}}"style="font-size: 15px; text-decoration: none; color: #545b62">
                    {{$item->catename}}
                </a>
                <hr>
                        ...
                        <div class="col-md-3">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <a href="{{route('edit',$pro['proid'])}}" class="btn btn-primary" style="width: 100%;
                                     height:30px; font-size: 15px ">Edit</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
